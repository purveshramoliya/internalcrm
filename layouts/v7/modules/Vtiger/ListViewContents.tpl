					...
					{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
						...
						<td class="listViewEntryValue" data-name="{$LISTVIEW_HEADER->get('name')}" title="{$LISTVIEW_ENTRY->getTitle($LISTVIEW_HEADER)}" data-rawvalue="{$LISTVIEW_ENTRY_RAWVALUE}" data-field-type="{$LISTVIEW_HEADER->getFieldDataType()}">
							<span class="fieldValue">
								<span class="value" style="{if $LISTVIEW_HEADER->getFieldDataType() eq 'currency' } text-align  :  right {else if $LISTVIEW_HEADER->getFieldDataType() eq 'picklist'}  text-align  :  center {else if $LISTVIEW_HEADER->getFieldDataType() eq 'date'}  text-align  :  center {else if $LISTVIEW_HEADER->get('name') eq 'invoice_no' }  text-align  :  center {/if}" >
