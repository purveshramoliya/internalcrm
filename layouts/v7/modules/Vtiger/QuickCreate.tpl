                        ...
                        <table class="massEditTable table no-border">
                            <tr>
                                ...
                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                    ...
                                    {/if}
                                    <td data-id="q{$FIELD_MODEL->getFieldName()}" id="q{$FIELD_MODEL->getFieldName()}" class='fieldLabel col-lg-2'>
                                    ...
                                    {if $FIELD_MODEL->get('uitype') neq '83'}
                                        <td  data-id="q{$FIELD_MODEL->getFieldName()}" id="q{$FIELD_MODEL->getFieldName()}val" class="fieldValue col-lg-4" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
