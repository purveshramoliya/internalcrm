...
Vtiger_Index_Js("Vtiger_Edit_Js",{
    ...
    */
    ...
    registerBasicEvents : function(form){
        ...
        this.registerDependencyLeadsEvents();
    },
    ...
    registerDependencyLeadsEvents: function(callParent) {
        if(document.getElementById('qcf_1049')){
            document.getElementById('qcf_1049').style.display = 'none';
        }
        if(document.getElementById('qcf_1049val')){
            document.getElementById('qcf_1049val').style.display = 'none';
        }
        let valofField = '';
        if(document.getElementById('Leads_editView_fieldName_cf_1049')){
            valofField = document.getElementById('Leads_editView_fieldName_cf_1049').value;
        }

        if(valofField == null || valofField == "" ){
            if(document.getElementById('cf_1049')){
                document.getElementById('cf_1049').style.display = 'none';
            }
            if(document.getElementById('cf_1049val')){
                document.getElementById('cf_1049val').style.display = 'none';
            }
        }
        // jQuery('.leadstatus').on('change', function(e){
        //     var id = $(this).closest("td").attr('data-id');
        //   console.log(id);
        //     var currentTarget = jQuery(e.currentTarget);
        //     var Tasktype = currentTarget.val();
        //     if( Tasktype == 'Junk Lead'){
        //         if(id.startsWith("q")){
        //             if(document.getElementById('qcf_1049')){
        //                 document.getElementById('qcf_1049').style.display = 'table-cell';
        //             }
        //             if(document.getElementById('qcf_1049val')){
        //                 document.getElementById('qcf_1049val').style.display = 'table-cell';
        //             }
        //         } else {
        //             if(document.getElementById('cf_1049')){
        //                 document.getElementById('cf_1049').style.display = 'table-cell';
        //             }
        //             if(document.getElementById('cf_1049val')){
        //                 document.getElementById('cf_1049val').style.display = 'table-cell';
        //             }
        //         }
        ...
        //     }
        // });
        jQuery('.cf_952').on('change', function(e){
            var id = $(this).closest("td").attr('data-id');
            var currentTarget = jQuery(e.currentTarget);
            var Tasktype = currentTarget.val();
            if( Tasktype == 'Junk Lead' || Tasktype == 'Lost Lead' ){
                if(id.startsWith("q")){
                    if(document.getElementById('qcf_1049')){
                        document.getElementById('qcf_1049').style.display = 'table-cell';
                    }
