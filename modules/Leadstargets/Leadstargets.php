...
class Leadstargets extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_leadstargets';
	var $table_index= 'leadstargetsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_leadstargetscf', 'leadstargetsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_leadstargets', 'vtiger_leadstargetscf');
	...
	var $related_tables = Array( 
					'vtiger_leadstargetscf' => Array('leadstargetsid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_leadstargets'   => 'leadstargetsid',
	    'vtiger_leadstargetscf' => 'leadstargetsid');
	...
	var $list_fields = Array (
		...
		'Leadstargets No' => Array('leadstargets', 'leadstargetsno'),
/*'Leadstargets No'=> Array('leadstargets', 'leadstargetsno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Leadstargets No' => 'leadstargetsno',
/*'Leadstargets No'=> 'leadstargetsno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'leadstargetsno';
...
/*'Leadstargets No'=> 'leadstargetsno',*/
	...
	var $popup_fields = Array ('leadstargetsno');

	// For Alphabetical search
	var $def_basicsearch_col = 'leadstargetsno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'leadstargetsno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('leadstargetsno','assigned_user_id');

	var $default_order_by = 'leadstargetsno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Leadstargets::checkWebServiceEntry();
			Leadstargets::createUserFieldTable($moduleName);
			Leadstargets::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Leadstargets'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Leadstargets','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
