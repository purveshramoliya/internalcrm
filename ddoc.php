<html>
<title>Upload Document-Biztechnosys</title>
<head>
...
<body>
	...
	<form id="__vtigerWebForm" name="Upload Documents" action="http://localhost/internalcrm/modules/Webforms/capture.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<div class="container">
			<div class="form-group" x-data="{ fileName: '' }">
				<div class="input-group shadow">
					...
					<input type="file" x-ref="file" @change="fileName = $refs.file.files[0].name" name="file_2_1" id="file_2_1" class="d-none">
		...
		<div class="text-center">
			<input type="submit" value="Submit" id="Submit" class="btn btn-success" name="SubmitButton">
		</div>
	</form>
	 ...
	 <script type="text/javascript">
	   $('#__vtigerWebForm').submit(function(event){
                        ...
                        $.ajax({
                            ...
                            url: "http://localhost/internalcrm/newsendmaildata.php",
                            //async: false,
                            data: formData,
                            contentType: false,
                            processData: false,
