...
class EmailTemplates_ListView_Model extends Vtiger_ListView_Model {
	...
	private $querySelectColumns = array('templatename, foldername, subject', 'systemtemplate', 'module', 'description','templatepath');
	private $listViewColumns = array('templatename', 'subject', 'description', 'module','templatepath');
	...
	public function getListViewHeaders() {
		$fieldObjects = array();
		$listViewHeaders = array('Template Name' => 'templatename', 'Subject' => 'subject', 'Description' => 'description', 'Module Name' => 'module', 'EIS Executive' => 'templatepath');
