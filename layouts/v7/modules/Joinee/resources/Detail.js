...
Vtiger_Detail_Js("Joinee_Detail_Js", {
    ...
    convertLead: function (convertLeadUrl, buttonElement) {
        var instance = Joinee_Detail_Js.detailCurrentInstance;
        ...
        if (jQuery.isEmptyObject(Joinee_Detail_Js.cache)) {
            app.helper.showProgress();
            app.request.get({"url": convertLeadUrl}).then(
                    function (err, data) {
                        app.helper.hideProgress();
                        if (data) {
                            Joinee_Detail_Js.cache = data;
            ...
            instance.displayConvertLeadModel(Joinee_Detail_Js.cache, buttonElement);
        }
    }
    ...
    init: function () {
        this._super();
        Joinee_Detail_Js.detailCurrentInstance = this;
   },
    /*
