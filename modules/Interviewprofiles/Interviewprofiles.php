...
class Interviewprofiles extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_interviewprofiles';
	var $table_index= 'interviewprofilesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_interviewprofilescf', 'interviewprofilesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_interviewprofiles', 'vtiger_interviewprofilescf');
	...
	var $related_tables = Array( 
					'vtiger_interviewprofilescf' => Array('interviewprofilesid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_interviewprofiles'   => 'interviewprofilesid',
	    'vtiger_interviewprofilescf' => 'interviewprofilesid');
	...
	var $list_fields = Array (
		...
		'Interviewprofiles No' => Array('interviewprofiles', 'interviewprofilesno'),
/*'Interviewprofiles No'=> Array('interviewprofiles', 'interviewprofilesno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Interviewprofiles No' => 'interviewprofilesno',
/*'Interviewprofiles No'=> 'interviewprofilesno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'interviewprofilesno';
...
/*'Interviewprofiles No'=> 'interviewprofilesno',*/
	...
	var $popup_fields = Array ('interviewprofilesno');

	// For Alphabetical search
	var $def_basicsearch_col = 'interviewprofilesno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'interviewprofilesno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('interviewprofilesno','assigned_user_id');

	var $default_order_by = 'interviewprofilesno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Interviewprofiles::checkWebServiceEntry();
			Interviewprofiles::createUserFieldTable($moduleName);
			Interviewprofiles::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Interviewprofiles'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Interviewprofiles','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
